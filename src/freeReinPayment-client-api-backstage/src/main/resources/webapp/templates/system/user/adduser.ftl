    ...
    <form action="${contextPath!"" }/system/user/saveorupdateuser" method="post" id="form_admin_add">
		...
		<div class="form-group">
			...
			<div class="formControls">
				<input type="text" class="input-text" value="" placeholder="" id="userName" name="userName" datatype="userName" nullmsg="账号不能为空" errormsg="该帐号已经存在，请更换帐号!">
			</div>
		...
		<div class="form-group">
			...
			<div class="formControls">
				<input type="text" class="input-text" value="" placeholder="" id="cName" name="cName" datatype="*" nullmsg="姓名不能为空" />
			</div>
			<div class="col-4"> <span class="Validform_checktip"></span></div>
		</div>
		<div class="form-group">
			...
			<div class="formControls">
			<input type="password" placeholder="密码" name="userpwd" autocomplete="off" value="" class="input-text" datatype="*6-20" nullmsg="密码不能为空" />
			</div>
			<div class="col-4"> <span class="Validform_checktip"></span></div>
		</div>
		<div class="form-group">
			...
			<div class="formControls ">
		<input type="password" placeholder="确认新密码" autocomplete="off" class="input-text Validform_error" errormsg="您两次输入的新密码不一致！" datatype="*" nullmsg="请再输入一次新密码！" recheck="userpwd" id="newpassword2" name="newpassword2">
			</div>
			<div class="col-4"> <span class="Validform_checktip"></span></div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="formControls ">
				<input type="text" class="input-text" value="" placeholder="" id="mobliePhone" name="mobliePhone" datatype="m" nullmsg="手机不能为空">
			</div>
			<div class="col-4">
